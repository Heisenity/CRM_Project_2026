...
export type StaffPortalFeature = 'DASHBOARD' | 'PROJECT' | 'TASK_MANAGEMENT' | 'CUSTOMERS' | 'TEAMS' | 'TENDERS' | 'STOCK' | 'HR_CENTER' | 'FIELD_ENGINEER_ATTENDANCE' | 'INOFFICE_ATTENDANCE' | 'CUSTOMER_SUPPORT_REQUESTS' | 'STAFF_FEATURE_ACCESS' | 'TICKETS'
